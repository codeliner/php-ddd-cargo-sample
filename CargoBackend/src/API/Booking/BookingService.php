...
namespace Codeliner\CargoBackend\API\Booking;

use Codeliner\CargoBackend\API\Booking\Assembler\CargoRoutingDtoAssembler;
use Codeliner\CargoBackend\API\Booking\Assembler\RouteCandidateDtoAssembler;
use Codeliner\CargoBackend\API\Booking\Dto\CargoRoutingDto;
use Codeliner\CargoBackend\API\Booking\Dto\LocationDto;
use Codeliner\CargoBackend\API\Booking\Dto\RouteCandidateDto;
use Codeliner\CargoBackend\API\Exception\CargoNotFoundException;
 ...
 *
 * @package Codeliner\CargoBackend\API\Booking
...
class BookingService implements BookingServiceInterface
{
     ...
     * @throws \Codeliner\CargoBackend\API\Exception\CargoNotFoundException
