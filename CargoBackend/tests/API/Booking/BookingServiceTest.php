...
class BookingServiceTest extends TestCase
{
    ...
    public function it_loads_cargo_for_routing()
    {
        ...
        $this->assertInstanceOf('Codeliner\CargoBackend\API\Booking\Dto\CargoRoutingDto', $cargoRoutingDto);
    ...
    public function it_provides_possible_routes_for_cargo()
    {
        ...
        $this->assertInstanceOf('Codeliner\CargoBackend\API\Booking\Dto\RouteCandidateDto', $routeCandidate);

        $legs = $routeCandidate->getLegs();

        $this->assertEquals(1, count($legs));

        $this->assertInstanceOf('Codeliner\CargoBackend\API\Booking\Dto\LegDto', $legs[0]);
    }
    ...
    public function it_lists_available_shipping_locations()
    {
        ...
        $this->assertInstanceOf('Codeliner\CargoBackend\API\Booking\Dto\LocationDto', $locations[0]);
