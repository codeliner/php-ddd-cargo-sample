...
namespace CargoBackend\Infrastructure\Persistence\Doctrine\Type;
 ...
 *
 * @package CargoBackend\Infrastructure\Persistence\Doctrine\Type
 * @author Alexander Miertsch <kontakt@codeliner.ws>
 */
class LegsDoctrineType extends TextType
{
    /**
     * @return string
     */
